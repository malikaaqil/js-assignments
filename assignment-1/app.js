...
// 1. Variable names can only contain letters, numbers, underscores(_) and dollar signs($).For example : $my_1stVariable.

// 2. Variables must begin with a letter, underscore(_) or dollar sign($). For example : $name, _name or name.
